...
<ts-section pageTitle="公司资质" class="aptitude">
  ...
  <div class="aptitude-row">
    ...
    <label class="aptitude-plus-img" v-if="Close.isShow" v-show="aptitudeFirm.aptitudeUrl.length<3">
...
export default {
  ...
  methods: {
    ...
    upload(e) {
      // 放到表单
      this.aptitudeFirm.aptitudeUrl.push(ALI_DOMAIN + e[e.length - 1].storeAs);
    },
    // 删除
