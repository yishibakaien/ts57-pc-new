      ...
      <ts-section pageTitle="花型预览" class="onepx">
        <div slot="menu">
           <label v-if="!$slots.uploadBtn">
            <div class="dress-upload--btn">
              <i class="icon-shangchuan"></i> 传图试衣
              <input type="file" accept="image/jpeg,image/jpg,image/png"  name="file" value="" @change="handleUpload" v-show="false">
            </div>
          </label>
          <input type="file" accept="image/jpeg,image/jpg,image/png"  v-show="false" name="file" value="" @change="handleUpload">
